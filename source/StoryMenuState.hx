...
// the score you have at the top left
		scoreText = new FlxText(10, 10, 0, "SCORE: 49324858", 36);
		scoreText.setFormat(Paths.font("funkin.otf"), 32);
// the week name on the top right
		txtWeekTitle = new FlxText(FlxG.width * 0.7, 10, 0, "", 32);
		txtWeekTitle.setFormat(Paths.font("funkin.otf"), 32, FlxColor.WHITE, RIGHT);
...
// this is the var that the game uses so it doesnt need to keep refering to the same
		var ui_tex = Paths.getSparrowAtlas('campaign_menu_UI_assets');
		// the yellow crap that goes behind the chars and bg
...
// week thing is like the difficulty stuff and the weej icons or what ever the hell you call them
		...
		var bgblack:FlxSprite = new FlxSprite(0, 56).makeGraphic(FlxG.width, 20, 0xFF000000);
		add(bgblack);
		...
		leftArrow.setPosition(430,-15);

		// this is the difficulty thingy whatevetr fjklsddsf0939qewfodsao-w45980e4w-wery9-ier-0-wtoekorpserkopdkopjfiph
		...
		add(txtWeekTitle);
		/* 
		var bfwhiteicon:FlxSprite = new FlxSprite(500,600).loadGraphic(Paths.image('bf-white-icon'));
		add(bfwhiteicon);
		bfwhiteicon.setGraphicSize(Std.int(bfwhiteicon.width * 0.5));
		bfwhiteicon.updateHitbox();
				*/
		changeWeek();
	...
	function changeDifficulty(change:Int = 0):Void
		// finally the difficulties thingy
	{
