...
class ClientPrefs {
	...
	public static var hitAudio:String = "normal tick";

	public static var bouncy:Bool = true;
	public static var hitSounds:Bool = false;
	public static var JudgeCount:Bool = false;
	...
	public static var funni:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.bouncy = bouncy;


		FlxG.save.data.camZooms = camZooms;
		FlxG.save.data.funni = funni;
		FlxG.save.data.JudgeCount = JudgeCount;


		FlxG.save.data.noteOffset = noteOffset;
		FlxG.save.data.hitAudio = hitAudio;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.funni != null) {
			flashing = FlxG.save.data.funni;
		}
		if(FlxG.save.data.hitAudio != null) {
			hitAudio = FlxG.save.data.hitAudio;
		}
		...
		if(FlxG.save.data.JudgeCount != null) {
			JudgeCount = FlxG.save.data.JudgeCount;
		}
		...
		if (FlxG.save.data.mute != null)
		{
			...
			if (FlxG.save.data.hitAudio == 3)
				{
					hitAudio = 'normal tick';
				}
